...
import { reset, AssignNCR } from "../../redux/features/ncr/ncrSlice";
...
const Assignment = ({ open, setOpen, id }) => {
  ...
  return (
    <Box component="form" variant="form" onSubmit={handleSubmit}>
            ...
            <div style={{ display: "flex", marginBottom: "10px" }} key={index}>
              ...
              <FormControl variant="filled" fullWidth sx={{ mx: 2 }}>
                ...
                >
                  ...
                  <MenuItem value="Karabo Notwana">Karabo Notwana</MenuItem>
                  <MenuItem value="Thabiso Bokaba">Thabiso Bokaba</MenuItem>
                </Select>
              </FormControl>
      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        ...
        <TextField
          ...
          sx={{
            border: submit && priority === "" ? "1px solid red" : "inherit",
            width: 150,
          }}
        >
          <MenuItem value="">
